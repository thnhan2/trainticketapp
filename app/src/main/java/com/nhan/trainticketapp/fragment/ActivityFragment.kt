...
import com.nhan.trainticketapp.DetailTicketActivity
...
class ActivityFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        ticketAdapter = TicketAdapter(ticketList, object : TicketAdapter.OnItemClickListener {
            override fun onDetailClick(ticket: Ticket) {
                val intent = Intent(activity, DetailTicketActivity::class.java)
                intent.putExtra("seat", ticket.seat.toString())
                intent.putExtra("trainId", ticket.train_id.toString())
